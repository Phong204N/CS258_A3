...
def main(**kwargs):
    ...
    net["r1"].cmd("ip route add 10.0.2.0/24 via 10.0.1.2 dev r1-eth3")
    net["r2"].cmd("ip route add 10.0.0.0/24 via 10.0.1.1 dev r2-eth1")
    net["r2"].cmd("ip route add 10.0.3.0/24 via 10.0.1.1 dev r2-eth1")
